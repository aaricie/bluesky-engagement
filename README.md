...
It reads **only public data** over the AT Protocol. No login is required, it is only offered as reading inbound engagement is much faster (22x per page which compounds to more than 100x per inbound accounts).
